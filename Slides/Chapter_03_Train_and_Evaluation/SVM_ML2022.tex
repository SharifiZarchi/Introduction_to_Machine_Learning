...
\begin{document}
	...
	\frame{\frametitle{Maximal Margin Classifier}
		...
		\begin{itemize}
			...
			The separating hyperplane with the largest between-class margin.
			\begin{equation}
				\begin{aligned}
	...
	\frame{\frametitle{Maximal Margin Classifier: Quadratic Program}
		...
		\begin{itemize}
			...
			%\begin{figure}
			%	\centering
			%	\includegraphics[scale=0.05]{Figs/maximal_hyperplane1.png}
			%	%\caption{Optimal Hyperplane, \%href{https://commons.wikimedia.org/wiki/File:SVM_margin.png}{Source}}
			%\end{figure}
	...
	\frame{\frametitle{Noisy Data}
		...
		\begin{itemize}
			...
			\item The \textcolor{Blue}{\textit {support vector classifier} (SVC)} maximizes a \tc{keywords}{soft}} margin.
	...
	\frame{\frametitle{Effect of Regularization Parameter}
		...
		\begin{itemize}
			...
			\item \textit C is a regularization parameter that controls the \tc{keywords}{bias-variance trade-off} of the support vector classifier.
			\begin{figure}
				\centering
