	...
	\frame{\frametitle{Maximal Margin Classifier}
		...
		\begin{itemize}
			...
			\begin{figure}
				...
				\centering
				\includegraphics[scale=0.38]{images/possible_hyperplanes.png}}
			\end{figure}
		
			\item \textbf{Maximal(Optimal) Separating  Hyperplane}: 
			The separating hyperplane with the biggest margin between the classes.
			
			\begin{equation}
				\begin{aligned}
					\max_{\beta_0,\beta,M} \quad & M\\
					\textrm{s.t.} \quad & \sum_{j=1}^{p}{\beta_j^2}\\
	...
	\frame{\frametitle{Polynomial Kernels}
		...
		\begin{itemize}
			...
			\begin{figure}
				\href{https://hastie.su.domains/ISLR2/ISLRv2_website.pdf}{
					\centering
					\includegraphics[scale=0.5]{images/polynomial3_kernel.png}
				}
			\end{figure}
	...
	\frame{\frametitle{Radial Basis Kernels}
		...
		\begin{itemize}
			...
			\begin{figure}
				\href{https://hastie.su.domains/ISLR2/ISLRv2_website.pdf}{
					\centering
					\includegraphics[scale=0.55]{images/rbf_kernel.png}
				}
			\end{figure}
