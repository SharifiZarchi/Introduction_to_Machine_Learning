...
\begin{frame}{K-Means in Action}
    \begin{figure}
        \centering
        \includegraphics[width=0.6\textwidth]{pic/kmeans_in_action_figures/kmeans_initial_data.png}
    \end{figure}
\end{frame}
...
\begin{frame}{K-Means in Action}
    \begin{figure}
        \centering
        \includegraphics[width=0.6\textwidth]{pic/kmeans_in_action_figures/kmeans_assignment_iter_1.png}
    \end{figure}
\end{frame}
...
\begin{frame}{K-Means in Action}
    \begin{figure}
        \centering
        \includegraphics[width=0.6\textwidth]{pic/kmeans_in_action_figures/kmeans_update_iter_1.png}
    \end{figure}
\end{frame}
...
\begin{frame}{K-Means in Action}
    \begin{figure}
        \centering
        \includegraphics[width=0.6\textwidth]{pic/kmeans_in_action_figures/kmeans_assignment_iter_2.png}
    \end{figure}
\end{frame}
...
\begin{frame}{K-Means in Action}
    \begin{figure}
        \centering
        \includegraphics[width=0.6\textwidth]{pic/kmeans_in_action_figures/kmeans_update_iter_2.png}
    \end{figure}
\end{frame}
...
\begin{frame}{K-Means in Action}
    \begin{figure}
        \centering
        \includegraphics[width=0.6\textwidth]{pic/kmeans_in_action_figures/kmeans_assignment_iter_3.png}
    \end{figure}
\end{frame}
...
\begin{frame}{K-Means in Action}
    \begin{figure}
        \centering
        \includegraphics[width=0.6\textwidth]{pic/kmeans_in_action_figures/kmeans_update_iter_3.png}
    \end{figure}
\end{frame}
...
\begin{frame}{K-Means in Action}
    \begin{figure}
        \centering
        \includegraphics[width=0.6\textwidth]{pic/kmeans_in_action_figures/kmeans_assignment_iter_4.png}
    \end{figure}
\end{frame}
...
\begin{frame}{K-Means in Action}
    \begin{figure}
        \centering
        \includegraphics[width=0.6\textwidth]{pic/kmeans_in_action_figures/kmeans_update_iter_4.png}
    \end{figure}
\end{frame}
...
\begin{frame}{K-Means in Action}
    \begin{figure}
        \centering
        \includegraphics[width=0.6\textwidth]{pic/kmeans_in_action_figures/kmeans_assignment_iter_5.png}
    \end{figure}
\end{frame}
...
\begin{frame}{K-Means in Action}
    \begin{figure}
        \centering
        \includegraphics[width=0.6\textwidth]{pic/kmeans_in_action_figures/kmeans_update_iter_5.png}
    \end{figure}
\end{frame}
% \begin{frame}{K-Means overview}
%     \begin{itemize}
...
\begin{frame}{Strengths}
    \begin{itemize}
        ...
        \item \textbf{Efficient:} time complexity $O(tKnd)$, where
        \begin{itemize}
            \item $n$ is the number of data points,
            \item $K$ is the number of clusters,
            \item $t$ is the number of iterations (it requires initial centroids, and the choice is important as it could affect $t$ in $O(tKn)$), and
...
{\tiny \hfill\strut Source: dataaspirant.com}
\end{frame}
...
\begin{frame}{Core Concepts in DBSCAN}
    ...
    \begin{itemize}
        \item \textbf{Core Point}: Has at least \texttt{minPts} points (including itself) within distance $\epsilon$.
        \item \textbf{Border Point}: Not a core point, but within distance $\epsilon$ of a core point.
        \item \textbf{Noise (Outlier)}: Neither core nor border.
    \end{itemize}
    \begin{figure}
        \centering
...
%--------------------------------------------------slide76
\begin{frame}{DBSCAN Algorithm (Main Procedure)}

\textbf{Main DBSCAN Loop}

\begin{enumerate}
    \item Mark all points as unvisited.
    \item For each point $x_i$:
    \begin{itemize}
        \item If $x_i$ is visited, continue.
        \item Mark $x_i$ as visited and compute $N_\epsilon(x_i)$.
        \item If $|N_\epsilon(x_i)| < \texttt{minPts}$:
              temporarily label $x_i$ as noise.
        \item Else:
              create a new cluster $C$ and
              add $x_i$ to it.
              Then call \textbf{ExpandCluster($x_i$, $N_\epsilon(x_i)$, $C$)}.
    \end{itemize}
\end{enumerate}
...
\begin{frame}{DBSCAN: Cluster Expansion}

\textbf{ExpandCluster(seed, neighbors, C)}

\begin{itemize}
    \item Initialize a queue with all points in \textit{neighbors}.
    \item While the queue is not empty:
    \begin{itemize}
        \item Pop a point $x_j$ from the queue.
        \item If $x_j$ is unvisited:
            \begin{itemize}
                \item Mark $x_j$ as visited.
                \item Compute $N_\epsilon(x_j)$.
                \item If $|N_\epsilon(x_j)| \ge \texttt{minPts}$:
                      append all of $N_\epsilon(x_j)$ to the queue.
            \end{itemize}
        \item If $x_j$ is not yet assigned to any cluster:
              add $x_j$ to cluster $C$.
    \end{itemize}
\end{itemize}
