\frame{\frametitle{The intuition}
	\myheading{Module 23.1: Generative Adversarial Networks - The intuition}
...
\begin{frame}
	\begin{columns}
		...
		\vspace*{0mm}
			\begin{center}
			\onslide<2->{\scalebox{0.35}{\input{modules/Module1/tikz_images/rbm.tex}}}
			\onslide<2->{\scalebox{0.35}{\input{modules/Module1/tikz_images/vae.tex}}}\\
			\onslide<2->{\vspace*{5mm} \scalebox{0.45}{\input{modules/Module1/tikz_images/nade.tex}}}
			\end{center}
		\end{overlayarea}
...
\begin{frame}[shrink=25]
	\begin{overlayarea}{\textwidth}{\textheight}
		\vspace{2mm}
		\scalebox{1.2}{With that we are now ready to see the full algorithm for training GANs}
		\input{modules/Module1/tikz_images/algo.tex}
	\end{overlayarea}
\end{frame}
