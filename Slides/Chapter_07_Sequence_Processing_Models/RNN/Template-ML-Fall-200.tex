...
\vspace{-0.3cm}
\begin{figure}[!h]
\centering \includegraphics[width=6cm]{Figs/The-LSTM-unit-contain-a-forget-gate-output-gate-and-input-gate-The-yellow-circle.png}
...
\begin{figure}[!h]
\centering \includegraphics[width=10cm]{Figs/rnn-bp.eps}
