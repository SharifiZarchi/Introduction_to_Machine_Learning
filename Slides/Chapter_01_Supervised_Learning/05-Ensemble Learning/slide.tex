...
\begin{frame}{Loss function}
    \begin{itemize}
        ...
        \end{itemize}
        \item[] \begin{center}
            $\mathcal{L}(y,\hat{y})=e^{-y \times H_M(\boldsymbol{x})}$
        \end{center}
        \item[] \begin{center}
...
\begin{frame}{Step 1: calculating the exponential loss}
    \begin{itemize}
        \itemsep1em
        \justifying
        \item First, we need to calculate the exponential loss for:
        \item[] \begin{center}
            $H_m(\boldsymbol{x}) = 
...
\begin{frame}{Step 2: Deriving the weighted error function}
    \begin{itemize}
        \itemsep1em
        \justifying
        \item Second, we need to derive the weighted error function, $J_m$
    \end{itemize}
    \begin{align*}
...
\begin{frame}{Step 3: Deriving $\epsilon_m$ and $\alpha_m$}
    \begin{itemize}
        \itemsep1em
        \justifying
        \item Third, we need to derive $\epsilon_m$ and $\alpha_m$ by setting the derivative equal to zero:
        \item[] \begin{center}
...
\begin{frame}{Step 4: justifying the weight update mechanism}
    \begin{itemize}
        \itemsep1em
        \justifying
        \item Fourth, we need to justify the weight update mechanism.
