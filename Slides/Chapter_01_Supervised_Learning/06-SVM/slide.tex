...
Maximize with respect to $\boldsymbol{\alpha}$, subject to \quad 
$\alpha_n \ge 0 \quad \text{for } n = 1, \ldots, N,
\quad \text{and} \quad 
\sum_{n=1}^{N} \alpha_n y_n = 0.
$
...
\begin{itemize}
    ...
    \[
        K(\mathbf{x}, \mathbf{x}') 
        = \exp\!\left(-\frac{\|\mathbf{x} - \mathbf{x}'\|^2}{\gamma}\right)
    \]
...
\begin{itemize}
    ...
    \[
        b + \sum_{\alpha_i > 0} \alpha_i y_i
        \exp\!\left(-\frac{\|\mathbf{x} - \mathbf{x_i} \|^2}{\sigma}\right) = 0
    \]
...
\alpha_i y^{(i)} 
\exp\!\left(
    -\frac{\|\mathbf{x} - \mathbf{x}^{(i)}\|^2}{2\sigma^2}
\right)
\]
