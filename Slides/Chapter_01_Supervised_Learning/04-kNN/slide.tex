...
\begin{frame}{kNN classifier cont.}
    \begin{itemize}
        \item With kNN we can obtain non-linear decision surfaces unlike the previous methods (linear and logistic regression)
        \item But note that this method could be prone to outliers or noisy data especially if:
        \begin{itemize}
            \item We have small dataset
            \item Our data is low-dimensional
            \item We use a small value of $k$ (like $k=1$ is only determined by the nearest neighbor and could be misleading in many test cases.
        \end{itemize}
    \end{itemize}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{frame}{Performance metrics}
    ...
    \begin{minipage}{0.6\textwidth} % Left side for the table
        \begin{table}[h!]
            \centering
            \begin{tabular}{@{}lcc@{}}
                \toprule
...
\begin{frame}{Performance metrics cont.}
    \begin{figure}[h]
            ...
            \includegraphics[width=0.9\textwidth]{pic/prass.png}
            % \caption* { \scriptsize [}
            % \label{fig:image1}
            \end{figure}
\end{frame}
...
\begin{frame}{AUC-ROC}
    ...
    \begin{figure}[h]
            ...
            \includegraphics[width=0.4\textwidth]{pic/image.png}
            % \caption* { \scriptsize [}
            % \label{fig:image1}
            \end{figure}
