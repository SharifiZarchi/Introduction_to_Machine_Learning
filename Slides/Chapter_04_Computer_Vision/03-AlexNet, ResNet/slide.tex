...
\begin{frame}{Intuition}
	...
	\begin{itemize}
		...
		\item We can represent this function with $3n+1$ \newline nodes \item many nodes to do this in a shallow network. 
...
\begin{frame}{Backprop In Residual Block}
	...
	\vspace{2.2cm}
	\begin{itemize}
		\item If the gradient of Path 1 vanished to 0, the gradient of Path 2 \newline still remained (because this gradient does not encounter any \newline weight layer)
	\end{itemize}
\end{frame}
