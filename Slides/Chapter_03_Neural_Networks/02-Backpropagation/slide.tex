...
%\begin{frame}{Effect of Learning Rate on Gradient Descent}
%    \begin{center}
%        \includegraphics[width=\textwidth]{pic/11111.png}
%    \end{center}
%\end{frame}
...
%     \begin{itemize}
%         \item Highly sensitive to outliers due to the squared term.
%         \item Penalizes large errors more heavily, leading to significant penalization of outliers.
%     \end{itemize}
% \end{frame}
...
%     \textbf{Characteristics:}
%     \begin{itemize}
%         \item Less sensitive to outliers as it uses the absolute value.
...
%     \textbf{MSE Impact:}
%     \begin{itemize}
%         \item Amplifies larger errors, leading to smooth outputs.
%         \item In autoencoders, high MSE values often result in blurrier images.
%         \item Reducing MSE (e.g., from 0.1 to 0.01) can improve detail, refining blurry images to clearer ones.
%     \end{itemize}
    
%     \textbf{MAE Impact:}
%     \begin{itemize}
%         \item Treats errors uniformly, often resulting in sharper outputs.
%         \item Less prone to outlier distortion, preserving details without averaging.
%     \end{itemize}
% \end{frame}

% \begin{frame}{\textbf{Gradient and Optimization Differences}}
%     \begin{itemize}
%         \item \textbf{MSE} provides a quadratic gradient, promoting faster convergence for large errors but slowing down as errors decrease.
%         \item \textbf{MAE} has a constant gradient, making optimization stable but slower compared to MSE when dealing with large errors.
%     \end{itemize}
% \end{frame}

% \begin{frame}{\textbf{Summary}}
%     \begin{itemize}
%         \item \textbf{MSE} is suitable for models that benefit from penalizing large errors heavily.
%         \item \textbf{MAE} is better for robust models that handle outliers and avoid smoothing effects.
%         \item Choice of loss function affects the accuracy and characteristics of model outputs.
%     \end{itemize}
% \end{frame}
...
\begin{itemize}
    ...
    item \href{https://github.com/}{Mohammad Aghaei}
\end{itemize}
\end{itemize}
